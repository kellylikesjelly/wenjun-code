...
# default config for BipedalWalker-AdversarialEnv
# 1. ground_roughness = 0, 
# 2. pit_gap          = [0,10], 
# 3. stump_width      = [4,5], 
# 4. stump_height     = [0,5], 
# 5. stump_float      = [0,1], 
...
# params range for BipedalWalker-AdversarialEnv
PARAM_RANGES_FULL = {
...
### Version History
# - v3: returns closest lidar trace instead of furthest, and faster video recording;
...
# To use hardocre env, create it by specifying the hardcore keyword, i.e., 'gym.make("BipedalWalker-v3", hardcore=True)'



# 1. 'BipedalWalker-v3': 
#      ground_roughness=0, pit_gap=[], stump_width=[], stump_height=[], stump_float=[], stair_height=[], stair_width=[], stair_steps=[];

# 2. 'BipedalWalkerHardcore-v3': not sure yet
#      ground_roughness=0, pit_gap=[], stump_width=[], stump_height=[], stump_float=[], stair_height=[], stair_width=[], stair_steps=[];

# 3. 'BipedalWalker-Med-Roughness-v0': 
#      ground_roughness=5, pit_gap=[], stump_width=[], stump_height=[], stump_float=[], stair_height=[], stair_width=[], stair_steps=[];

# 4. 'BipedalWalker-Med-StumpHeight-v0': 
#      ground_roughness=0, pit_gap=[], stump_width=[1, 2], stump_height=[2, 2], stump_float=[0, 1], stair_height=[], stair_width=[], stair_steps=[];

# 5. 'BipedalWalker-Med-PitGap-v0': 
#      ground_roughness=0, pit_gap=[5, 5], stump_width=[], stump_height=[], stump_float=[], stair_height=[], stair_width=[], stair_steps=[];

# 6. 'BipedalWalker-Med-Stairs-v0': 
#      ground_roughness=0, pit_gap=[], stump_width=[], stump_height=[], stump_float=[], stair_height=[2, 2], stair_width=[4, 5], stair_steps=[5];
